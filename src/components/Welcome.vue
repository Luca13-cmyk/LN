<template>
  <div class="bgcoverper">
      ...
      <section id="version-per">
        <b><a rel="noopener noreferrer">Versão 1.0.0</a>  </b>
    </section>
    <v-container>
        ...
        <v-row align="center" justify="center">
          ...
          <div class="content-terminal">
              <div class="header-top">
                ...
                <div class="icons-per-terminal" style="position:absolute;right: 5px;top:50%;transform: translateY(-50%)">
              ...
              <div class="box-code-per">
                  <section class="content-terminal-type">
                        <b style="color: white;"><span style="color: rgba(255, 0, 0, 0.562)">ln-app@ln-app-OEM</span>:<span style="color:rgba(0, 255, 255, 0.658)">~</span>$</b> <p class="bash-per" style="padding-left: 10px"></p> 
                  </section>
              </div>
          </div>
        </main>
        ...
        <footer class="mt-12">
          <div>
            <p class="footer-p">Desenvolvido por <a  href="mailto:lucanegrette1303@gmail.com">Luca Negrette</a></p>
          </div>
        </footer>
        </v-row>
...
export default {
    ...
    mounted() {
        ...
        new Typed(".bash-per", {
            strings: ["apt update", "ls -la", "apt install", "ifconfig", "msfconsole"],
